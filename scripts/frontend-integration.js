 ...
 * This file demonstrates how to integrate Nodez with a web frontend
 */

// For React/Vue/Angular applications
export class NodezClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NodezClient(provider, contractAddress);
